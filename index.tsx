...
const AppContainer: FC = () => {
    ...
    const [isLoading, setIsLoading] = useState(false); // Aggiunto per feedback visivo
    ...
    // NUOVA FUNZIONE handleLogin SICURA
        ...
        return (
            <div className="lock-screen-container">
                <div className="lock-screen-box">
                    ...
                    <p>Inserisci la password per accedere al Consulente SCV.</p>
