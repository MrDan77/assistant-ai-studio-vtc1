...
// --- Main App Component ---
// --- AppContainer con Disclaimer e Sicurezza ---
                ...
                <div className="lock-screen-box" style={{maxWidth: '700px'}}>
                    ...
                    <form onSubmit={handleLogin}>
                        <div className="acceptance" style={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px', fontSize: '14px'}}>
                            ...
                            />
                            <label htmlFor="accept-checkbox" style={{cursor: 'pointer'}}>Dichiaro di aver letto, compreso e accettato le Avvertenze d'Uso.</label>
                        </div>
                        <input
